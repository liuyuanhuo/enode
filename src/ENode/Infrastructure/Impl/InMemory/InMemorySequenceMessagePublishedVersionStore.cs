...
namespace ENode.Infrastructure.Impl.InMemory
{
    public class InMemorySequenceMessagePublishedVersionStore : ISequenceMessagePublishedVersionStore
    {
        ...
        public Task<AsyncTaskResult> UpdatePublishedVersionAsync(string processorName, int aggregateRootTypeCode, string aggregateRootId, int publishedVersion, DateTime finishedTime)
        {
