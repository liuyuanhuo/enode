...
namespace ENode.Configurations
{
    public class ConfigurationSetting
    {
        ...
        public ConfigurationSetting()
        {
            ...
            SqlServerSequenceMessagePublishedVersionStoreSetting = new DbTableSetting(this) { TableName = "Part_SequenceMessagePublishedVersion", PrimaryKeyName = "PK_SequenceMessagePublishedVersion" };
